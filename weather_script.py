...
print(''' <html>
<head>
   <title>Weather Map Lab by Young</title>
''')
...
# got help here: https://stackoverflow.com/questions/45464364/changing-css-fill-for-svg-with-js
print("document.getElementsByClassName('co')[0].setAttribute('fill', '#CFB87C');")
# testing to turn them all gold; this worked
#for d in ds:
  #print(f"document.getElementsByClassName('{d}')[0].setAttribute('fill', '#CFB87C');")

# dictionary of states and long/lat
ds = getDict()

i = 0
for d in ds:
    val = getWeather(d, ds[d])
    #print("document.getElementsByClassName('co')[0].setAttribute('fill', '#CFB87C');")
    print(f"document.getElementsByClassName('{val[0]}')[0].setAttribute('fill', '{val[1]}');")
    # if the function didn't fail and return gray, add 1 to i
    if val[1] != '#D0D0D0':
      i+=1
    # limit of 5 states to make it easier for the graders per instructions in assignment
    # It works for all 50 states I removed this limit and it worked perfectly
    if i >= 5:
        break
print('''
};
